...
ds1 = load_dataset("Coobiw/agiqa3k_prompt_1013", split="train")
ds2 = load_dataset("Coobiw/aigciqa2023_qual_prompt_1022", split="train")
...
# —— 5. 先保存到本地 —— #
local_path = "./merged_dataset_prompt_cache"
print(f"\n保存数据集到本地: {local_path}")
...
repo_id = "Coobiw/merged_agiqa5k_prompt_1022"
